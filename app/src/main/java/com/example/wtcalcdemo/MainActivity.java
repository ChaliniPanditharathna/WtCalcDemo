...
public class MainActivity extends AppCompatActivity {
    ...
    //Added another line from local on Feb 08th
        ...
        radGroupConv.setOnCheckedChangeListener(
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                try {
                    ...
                    if (inputWt <= 0) {
                        Toast.makeText(MainActivity.this, "Input weight should not less than 0",
                        ...
                        if (inputWt > 1000) {
                            ...
                            txtViewResults.setText(String.format("Converted weight: %.2f", outputWt));
                        }
